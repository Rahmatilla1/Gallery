...
signUp: async(req, res) => {
    ...
    try {
      ...
      return res.status(201).json({ message: "Created successfully",user: otherDetails, token});
  ...
  login: async (req, res) => {
    ...
    try { 
      if (email && password) {
        ...
        return res.status(200).send({ message: "Login successfully", user: otherDetails, token });
      } else {
